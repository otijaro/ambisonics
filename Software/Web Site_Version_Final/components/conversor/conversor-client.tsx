        ...
        <div className="rounded-3xl glass p-6 sm:p-8">
          ...
          {!isLoading && (
            <div className="mt-4 text-center text-xs text-muted-foreground">
              {user ? (
                <p>Esta conversión quedará disponible en <Link href="/mis-conversiones" className="text-primary hover:underline">Mis conversiones</Link> durante 24 horas.</p>
              ) : (
                <p>Puedes convertir sin crear una cuenta. Si deseas volver a acceder a tus resultados durante las próximas 24 horas, <Link href="/login" className="text-primary hover:underline">inicia sesión</Link> o <Link href="/crear-cuenta" className="text-primary hover:underline">crea una cuenta</Link>.</p>
              )}
            </div>
          )}
